package com.project.BabycareService.Model;
...
public class BabycareProduct {
	...
	public void BabyCareProduct() {

	}

	public void BabyCareProduct(String productId, String productName, Date product_Mfg_Date, Date product_Exp_Date) {

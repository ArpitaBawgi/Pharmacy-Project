package com.project.MedService.Model;
...
public class Medicine {
	...
	public Medicine(String productId, String productName, Date product_Mfg_Date, Date product_Exp_Date) {
		super();
	...
	public String toString() {
		return "Medicine [productId=" + productId + ", productName=" + productName + ", product_Mfg_Date="

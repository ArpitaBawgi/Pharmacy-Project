package com.project.HaircareService.Model;
...
public class HaircareProduct {
	...
	public void HairCareProduct() {

	}

	public void HairCareProduct(String productId, String productName, Date product_Mfg_Date, Date product_Exp_Date) {
